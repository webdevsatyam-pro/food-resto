...
const Checkout = ({ cartItems, clearCart }) => {
  ...
  const handleConfirmOrder = () => {
    ...
    // Order Successful Logic
    setIsOrdered(true);
    clearCart(); // Cart ko khali karega (App.js se aa raha hai)

    setTimeout(() => {
      navigate("/"); // 3 second baad home page pe bhej dega
    }, 3000);
  };
    ...
    <div className="max-w-6xl mx-auto p-6 my-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <button
                ...
                className={`p-4 rounded-2xl font-bold border-2 transition-all ${paymentMethod === "cod" ? "border-orange-500 bg-orange-50 text-orange-600" : "border-gray-100 text-gray-500 hover:bg-gray-50"}`}>
                Cash on Delivery
              </button>
              <button
                onClick={() => setPaymentMethod("upi")}
                className={`p-4 rounded-2xl font-bold border-2 transition-all ${paymentMethod === "upi" ? "border-orange-500 bg-orange-50 text-orange-600" : "border-gray-100 text-gray-500 hover:bg-gray-50"}`}>
                UPI / Online
              </button>
            </div>
              ...
              <div className="bg-gray-50 p-6 rounded-2xl text-center border border-dashed border-gray-300">
                {!showQR ? (
                  <button
                    ...
                    className="flex items-center gap-2 bg-gray-800 text-white px-6 py-3 rounded-xl mx-auto hover:bg-black transition shadow-lg">
                  ...
                  <div className="space-y-4 animate-in fade-in zoom-in duration-300">
                    ...
                    <p className="text-xs text-orange-600 font-medium italic">
                      Click "Confirm Order" after scanning
                    </p>
                  </div>
                )}
              </div>
        ...
        <div className="bg-gray-900 text-white p-8 rounded-3xl shadow-xl h-fit sticky top-24">
          <h2 className="text-2xl font-bold mb-6 italic border-b border-gray-700 pb-4">
            Bill Details
          </h2>
          ...
          <button
            ...
            className="w-full bg-orange-500 text-white py-4 rounded-2xl font-bold text-lg hover:bg-orange-600 shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
            <CheckCircle size={22} />
            Place Order
          </button>
        </div>
